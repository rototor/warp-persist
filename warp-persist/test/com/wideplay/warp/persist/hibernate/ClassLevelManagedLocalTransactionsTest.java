...
public class ClassLevelManagedLocalTransactionsTest {
    ...
    private static final String UNIQUE_TEXT = "some unique text88888" + new Date();
    private static final String UNIQUE_TEXT_2 = "some asda unique teasdalsdplasdxt" + new Date();
    private static final String TRANSIENT_UNIQUE_TEXT = "some other unique texaksoksojadasdt" + new Date();
